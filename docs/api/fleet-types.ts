...
export interface MachineView {
  ...
  /**
   * Cảnh báo bridge SUY RA (máy lỗi, mất tín hiệu, dừng quá lâu, dữ liệu cũ), tính tại thời
   * điểm phục vụ yêu cầu.
   *
   * KHÁC `alerts` ở vòng đời, và đừng trộn hai nhóm:
   *  - `alerts` do bridge giữ ⇒ **xác nhận được** (`POST .../alerts/:id/acknowledge`).
   *  - `derivedAlerts` tự tắt khi máy trở lại ⇒ **không có nút xác nhận**; gửi acknowledge cho
   *    id của nhóm này thì bridge trả 400.
   */
  derivedAlerts: Alert[]
  alerts: Alert[]
}
