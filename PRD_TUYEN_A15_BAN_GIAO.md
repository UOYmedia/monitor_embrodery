...
| K‑19 | L0 | **UPTIME ≥ 99 % trong 7 ngày liền** trên cửa sổ sạch | ⏳ **Đang chạy — mốc đo tạm 26/08 06:07Z: 100,00 % trên 18,1 giờ, 0 lần gián đoạn.** Ca này đóng được **sớm nhất 2026-09-01** (đủ 7×24 giờ tính từ 25/08 11:59Z); trước ngày đó mọi con số đều là mốc giữa chừng, **không được ghi 🟩**. Một điều cần nói thẳng cho đội nhận: **phép đo này nhìn theo nhịp 30 giây** (mỗi dòng `enum-growth.csv` một mốc) nên **đứt ngắn hơn 30 giây thì nó không thấy** — và trong cửa sổ đã có **1 lần broker khởi động lại** (`2026-08-25T14:08:41Z`) mà uptime vẫn ghi 100 %, đúng như dự đoán: launchd dựng lại kịp trong một nhịp. Nên đọc con số này là *"tuyến không chết quá 30 giây lần nào"*, chứ không phải *"tiến trình chưa bao giờ tắt"*. Muốn số thứ hai thì đếm dòng khởi động lại — chính `do_on_dinh.py` đã in sẵn ở cuối báo cáo | `do_on_dinh.py --tu 2026-08-25T11:59:00Z` | 🟡 |
